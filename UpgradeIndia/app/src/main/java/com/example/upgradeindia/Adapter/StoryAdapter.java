...
import com.example.upgradeindia.AddStoryActivity;
import com.example.upgradeindia.Model.Story;
    ...
    private void userInfo(ViewHolder viewHolder, String userid, int pos){
        ...
        reference.addListenerForSingleValueEvent ( new ValueEventListener () {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                Glide.with ( mContext ).load ( user.getImagurl () ).into ( viewHolder.story_photo );
                if(pos != 0){
                    Glide.with ( mContext ).load ( user.getImagurl () ).into ( viewHolder.story_photo_seen );
